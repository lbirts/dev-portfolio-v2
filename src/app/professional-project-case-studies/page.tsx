...
const caseStudies = [
  {
    ...
    points: [
      "On contract, I built the coach-facing side of FlashMock, an AI interview prep and career coaching platform, including the dashboard and the tools coaches use to manage their AI agents.",
      "The dashboard gives coaches a snapshot of their business at a glance: packages offered, active agents, completed sessions, and mock interviews run.",
  ...
  {
    title: "SpecCheck - B2B Live Chat",
    points: [
      "I led frontend work on SpecCheck's real-time live chat for their B2B portal, built in React and TypeScript as a standalone module and part of a move off Intercom onto Sendbird.",
      "Support agents get a dashboard to handle multiple chats at once and see customer account details right next to the conversation.",
      ...
      "Messages flow over WebSockets so conversations feel instant, and the UI surfaces early replies from the SpecCheck Bot so common questions get triaged before a human joins.",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "The transaction list pulls in history and labels each item in plain language, Safe, Dangerous, or Suspicious, so users aren't left guessing at what they're looking at.",
      "When a transaction needs a second look, WebSockets drive real-time alerts: an email plus an in-app modal with scan results (wallet age, phishing signals, and similar checks) and a clear Approve or Deny step.",
      "The main dashboard charts security score, transaction health, and approval risk so the overall picture is easy to scan.",
      "I also shipped the rewards experience, a leaderboard, daily claims, and referrals, so staying protected felt engaging instead of only scary.",
    ],
